                ...
                <div class="top_menu_wrap2">
                    <p class="amdin_hi">
                        ...
                        <div class="top_menu_2">
                            ...
                            <li class="top_join"><a href="edit.php">회원정보</a></li>
                            <li class="top_cen"><a href="#">인증센터</a></li>
                            <li class="top_acc"><a href="../account/account.php">계좌개설</a></li>
                        </ul>
                    </div>
        ...
        <div class="lnb_wrap">
            ...
            <div class="lnb">
                <ul>
                    ...
                    <li><a href="edit.php" class="lnb_login">회원정보</a></li>
                </ul>
            </div>
        </div>
        <div class="join_wrap">
                    ...
                    <form name="edit_form" action="edit_ok.php" method="post" onsubmit="return form_check()">
                        <fieldset>
                            ...
                            <p>
                                ...
                                <input type="text" name="u_name" id="u_name" class="u_name" value="<?php echo $array["u_name"]; ?>">
                            </p>
                
                            <p>
                                <label for="mobile" class="label_txt">휴대폰번호</label>
                                <input type="tel" name="mobile" id="mobile" class="mobile" value="<?php echo $array["mobile"]; ?>">
                                <br>
                                <span class="ex_txt"></span>
                            </p>
                            <p>
                                <label for="u_id" class="label_txt">아이디</label>
                                <input type="text" name="u_id" id="u_id" class="u_id" value="<?= $array["u_id"]; ?>">
                            </p>
                            ...
                            <p>
                                ...
                                <input type="datetime" name="birth" id="birth" class="birth" value="<?php echo $birth; ?>">
                                <br>
                            ...
                            <p>
                                ...
                                <input type="text" name="postalCode" id="postalCode" class="postal_code" value="<?php echo $array["postalCode"]; ?>" readonly>
                                ...
                                <input type="text" name="addr1" id="addr1" class="addr1" value="<?php echo $array["addr1"]; ?>" readonly>
                                <br>
                            ...
                            <p>
                                ...
                                <input type="text" name="email_id" id="email_id" class="email_id" value="<?php echo $email; ?>">
                            </p>
                            <p class="button">
                                <button type="button" class="prev" onclick="history.back()">이전</button>
                                <button type="submit" class="btn_subimt">정보수정</button>
